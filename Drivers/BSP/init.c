...
void Board_Init()
{
	int param[] = 
	{
		...
		0x3d0f5c29,0x46136c00,0x3dcccccd,0x3dcccccd,0x3dcccccd,0x3c656042,0x3b656042,0x41c80000,
		0x41400000,0x3f333333,0x532d5444,0x354f4c4f,0x00005a48,0x00000000,0x44e74000,0x44e74000,
		0x3d4ccccd,0x3d4ccccd,0x3f19999a,0x3d99999a,0x3d99999a,0x42a00000,0x3d4ccccd,0x3d4ccccd,
		0x40a00000,0x3d99999a,0x3d99999a,0x459ed000,0x3dcccccd,0x3dcccccd,0x3dcccccd,0x3cb9f55a,
		0x3b449ba6,0x41b00000,0x41400000,0x3f333333
	};
	DP_EN(0);
	HAL_Delay(500);
	if(ADC_GetValue()<3.4)
	...
	if(settings.magic!=5566)
	{
		...
		memcpy(geoparam,param,sizeof(struct GeoParam)*2);
		FlashProgram();
	}
